...
class FACEEvaluator(object):
    ...
    def img_to_img_similarity(self, src_images, generated_images):
        ...
        return sim    
model=FACEEvaluator('cuda')
print(model.img_to_img_similarity('/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/dataset/unictokens_data/concept/test/adrien_brody/0.png','/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/dataset/unictokens_data/concept/test/adrien_brody/1.png'))
print(model.img_to_img_similarity('/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/dataset/unictokens_data/concept/test/adrien_brody/0.png','/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/showo/tmp_result/best_image/adrien_brody/image_000013.png'))
...
class SHOWO_P_FACEEvaluator(FACEEvaluator):
    def __init__(self, 
                 device, 
                 data_root='/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/dataset/unictokens_data',
                 work_dir='/share/project/emllm_mnt.1d/mnt/hpfs/baaiei/daigaole/code/UnicR1/showo',
                 save_dir='t2i_saved',
